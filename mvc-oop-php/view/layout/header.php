...
<ul class="nav">
    <li class="nav-item">
        <a class="nav-link active" href="../category/create_category.php">Create category</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="/mvc-oop-php/view/product/Create_product.php">Create Products</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="../product/products.php">Products</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="../category/category.php" tabindex="-1" aria-disabled="true">Categories</a>
    </li>
</ul>
